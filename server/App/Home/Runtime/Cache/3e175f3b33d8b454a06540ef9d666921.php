...
<html>
<head>
	<title>公司架构 组织架构</title>
	<meta name="keywords" content="广州普邦园林股份有限公司 广州普邦园林股份有限公司" />
	<meta name="description" content="广州普邦园林股份有限公司 广州普邦园林股份有限公司" />
...
<section class="content content-page center" id="content">
	<h1>
		<a href="mailto:<?php echo ($web["email"]); ?>" class="more" style="font-size:13px;padding:7px 15px;float:right;">申请本职位</a>
		<?php echo ($vo["title"]); ?>
		<small class="date"><?php echo ($vo["riqi"]); ?></small>
	</h1>
	<table class="job-table">
		<tbody><tr>
			...
			<td>有效期：</td>
			<td colspan="3"><?php echo ($vo["validity"]); ?></td>
		</tr>
		<tr>
			<td>招聘对象：</td>
