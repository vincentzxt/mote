...
<a href="/investment/fair.html" target="_blank"><img class="fair_float" width="110px" height="110px" src="__PUBLIC__/home/images/fair.png"/></a>
<style>
.fair_float{
	position: fixed;
	z-index: 99;
...
<section class="content center content-page" id="content">
	...
	<ul class="npic-list">
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$news): $mod = ($i % 2 );++$i;?><li class="column">
			<a href="__ROOT__/News/detail/id/<?php echo ($news["id"]); ?>" class="imagebox"><img src="/<?php echo ($news["Imageurl"]); ?>"></a>
			<a href="__ROOT__/News/detail/id/<?php echo ($news["id"]); ?>">
				<p class="date">2016-12-30</p>
					<span class="name" title="	<?php echo ($news["title"]); ?>">
						<?php echo ($news["title"]); ?>
						<i class="link-to"></i>
					</span>
			</a>
