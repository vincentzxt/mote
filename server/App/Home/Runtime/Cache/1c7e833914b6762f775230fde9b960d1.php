...
<html>
<head>
    <title><?php echo ($vo["tname"]); ?> - <?php echo ($web["webname"]); ?></title>
    <meta name="keywords" content="<?php echo ($vo["meta"]); ?> - <?php echo ($web["webname"]); ?>" />
    <meta name="description" content="<?php echo ($vo["des"]); ?> - <?php echo ($web["webname"]); ?> - <?php echo ($web["meta"]); ?>" />
...
<section class="content content-page center" id="content">
    <div class="icon-tabs large">
    <?php if(is_array($tophead)): $k = 0; $__LIST__ = $tophead;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tophead): $mod = ($k % 2 );++$k;?><a href="__ROOT__/<?php echo ($tophead["url"]); ?>" class="<?php if(($tophead["url"]) == $onurl): ?>tab-on<?php endif; ?>">
        <i class="<?php echo ($csstype[$k-1]); ?>"></i>
        <h2>
            <div><?php echo ($tophead["title"]); ?></div>
            <small><?php echo ($tophead["etitle"]); ?></small>
            <div class="after"></div>
        </h2>
