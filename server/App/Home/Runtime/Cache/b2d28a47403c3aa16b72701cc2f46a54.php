...
<section class="content center content-page" id="content">
    ...
    <div class="tab-list role-list" data-loop="false">
        <div class="list-inner">
            <?php if(is_array($years)): $k = 0; $__LIST__ = $years;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$years): $mod = ($k % 2 );++$k;?><a class="<?php if(($k) == "1"): ?>tab-on<?php endif; ?>">
                <div class="dot"></div>
                <div class="year"><?php echo ($years["title"]); ?></div>
            </a><?php endforeach; endif; else: echo "" ;endif; ?>
        </div>
    </div>
</div>
    <div class="tab-contents">
        <?php if(is_array($things)): $k = 0; $__LIST__ = $things;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$things): $mod = ($k % 2 );++$k;?><div class="tab-content  <?php if(($k) != "1"): ?>hidden<?php endif; ?>">
                <dl class="award-list">
                    <?php if(is_array($things["list"])): $i = 0; $__LIST__ = $things["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ttt): $mod = ($i % 2 );++$i;?><dd><span class="before"></span><span class="name"><?php echo ($ttt); ?></span></dd><?php endforeach; endif; else: echo "" ;endif; ?>
                </dl>
