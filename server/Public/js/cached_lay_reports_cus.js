...
function initTimeUnit(e,n){
  ...
  if( time_unit_component != undefined ){
    ...
    $.publish('/active_user',global.time_unit);
  }
};
	...
	return {
		...
		init : function(target,options){
			...
			var defaults = {
				...
				panelTempl : '<div class="filterpanel" style="display:none;"><input type="text" class="input" placeholder="搜索全部"/><ul class="filterlist"></ul><div class="load" style="margin:10px auto;text-align:center;display:block;"><img src="/BI/Public/images/ajax-loader.gif"/></div><div class="submitpanel"><a href="#" class="submit">确定</a></div></div>'
			};
			var settings = $.extend({},defaults,options);
...
var Contrast = function(){
	...
	this.bindSubmit = function(settings){
      ...
      $('#'+settings.contrastTo).after('<div class="loadingChart"><img src="/BI/Public/images/ajax-loader.gif" /></div>');
...
;(function($){
 $.fn.renderTable = function(options){
   return this.each(function(){
     ...
     if( settings.data == '' ){
       loading_icon.html('<img src="/BI/Public/images/ajax-loader.gif" />').show();
       $.ajax({
         url:settings.url,
      ...
      $.ajax({
        ...
        success: function(res){
          ...
          if( res == "" ) {
            ...
            $.template("respTemplate","<li key=${key} app_id=${appid}><img alt=${platform_name} title=${platform_name} width='20' src='//BI/Public/images/icons/${platform_pic_name}.png' />${name}</li>");
            $(".js-select-list li").remove();
...
function render_chart(chart_id, title, data_src_url, params, force_reload, opts,callback){
  ...
  if(!params.is_compared){
    var loading_img = $("<div style='text-align:center;padding-top:150px;'><img src='/BI/Public/images/ajax-loader.gif' /></div>");
 ...
 *    <span>
 *    </span>
 *    <a class="close-notify"><img class="hellobar-up-arrow" src="//BI/Public/images/icons/hellobar-up-arrow.png"></a>
 *  </div>
 *  <div class="hellobar-stub" style="display:none">
 *    <a class="show-notify"><img class="hellobar-down-arrow" src="//BI/Public/images/icons/hellobar-down-arrow.png"></a>
 *  </div>
 */
